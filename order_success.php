...
?>
						...
						<button name="order" class="btn btn-danger" onclick='window.location.href = "#"'>Track your Order</button>
						<button name="shopping" class="btn btn-success" onclick='window.location.href = "#"'>Continue Shoppping</button>
					</div>
