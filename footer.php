	...
	<div class="container">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				...
				<p class="fo-para"> All the daily pre-requisites at your doorstep with our one-stop market solutions </p>
				<ul class="social-fo">
				...
				<div class=" address">
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-home" aria-hidden="true"></i> MIT-WPU, Rambaug Conoly, Kothrud </p>
					</div>
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-phone" aria-hidden="true"></i> +91 9881517771 </p>	
					</div>
					<div class="col-md-4 fo-grid1">
						<p><a href="mailto:pchandle07@gmail.com.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> pchandle07@gmail.com </a></p>
					</div>
					<div class="clearfix"></div>
		...
		<div class="copy-right">
			<p> &copy; 2021 Grocery store. All Rights Reserved  </a></p>
